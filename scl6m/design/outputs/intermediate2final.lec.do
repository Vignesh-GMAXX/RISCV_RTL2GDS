...
# Generated on: Sat Apr 11 17:05:13 IST 2026 (Sat Apr 11 11:35:13 UTC 2026)
...
set_verification_information fv_map_microprocessor_pad_top_incrementalv_db

read_implementation_information fv/microprocessor_pad_top -golden fv_map -revised microprocessor_pad_top_incrementalv
...
read_design -verilog95   -golden -lastmod -noelab fv/microprocessor_pad_top/fv_map.v.gz
elaborate_design -golden -root {microprocessor_pad_top}

read_design -verilog95   -revised -lastmod -noelab ./outputs/microprocessor_pad_top_incremental.v
elaborate_design -revised -root {microprocessor_pad_top}

#add_name_alias fv/microprocessor_pad_top/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/microprocessor_pad_top/microprocessor_pad_top_incrementalv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.microprocessor_pad_top.fv_map.microprocessor_pad_top_incrementalv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.microprocessor_pad_top.fv_map.microprocessor_pad_top_incrementalv.rpt
}
report_test_vector -noneq > noneq.test_vector.microprocessor_pad_top.fv_map.microprocessor_pad_top_incrementalv.rpt
